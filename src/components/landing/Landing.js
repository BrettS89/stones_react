    ...
    return(
      <div className="container">
        <div className="jumbotron">
          <h1>Hand Crafted Jewelry by Susan Sodie</h1>
        </div>

        <div className="landing-feature">
          <div className="landing-feature-image-div" style={ {"background": "url('https://images.pexels.com/photos/356148/pexels-photo-356148.jpeg?auto=compress&cs=tinysrgb&h=350')" } }>
            <div></div>

          </div>
          <div className="landing-feature-content"> 
            <p>
              <strong>Pearl Necklaces</strong> <br/>
      ...
      <hr/>
        ...
        <div className="landing-feature" style={ {"flexDirection": "row-reverse"} }>
          <div className="lading-feature-image-div" >
            ...
            <div className="landing-feature-content" style={ {"marginLeft": 0, "marginRight": "30px"} }>
              <p>
